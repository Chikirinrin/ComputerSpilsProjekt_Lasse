            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                try{
                    ...
                    if(tollSize < 0 || riskRob < 0 || tollSize > 50 || riskRob > 50){
                        JOptionPane.showMessageDialog(frame, "'Toll to be paid' and 'Risk of robbery' must be between 0 and 50.", "Malformed input", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                } catch (NumberFormatException e){
                    JOptionPane.showMessageDialog(frame, "'Toll to be paid' and 'Risk of robbery' must be integers.", "Malformed input", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                try{
                    ...
                    if(minLoss < 0){
                        JOptionPane.showMessageDialog(frame,"'Min Loss when robbed value' must be positive.", "Illegal input", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                    if(minLoss > maxLoss){
                        JOptionPane.showMessageDialog(frame,"'Min Loss when robbed value' must be smaller than 'Max Loss value'.","Illegal input", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                    if (minLoss > 100){
                        JOptionPane.showMessageDialog(frame,"'Min Loss when robbed value' must be between 0 and 100.", "Illegal input", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                    if(maxLoss > 100){
                        JOptionPane.showMessageDialog(frame,"'Max Loss when robbed value' must be between 0 and 100.", "Illegal input", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                }catch(NumberFormatException e){
                    JOptionPane.showMessageDialog(frame,"'Max Loss when robbed' and 'Min Loss when robbed' must be integers.", "Illegal input", JOptionPane.ERROR_MESSAGE);
                    return;
                    }
